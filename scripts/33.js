    ...
    a = function (t) {
      ...
      var e = {
          ...
          a.rgb.hsl = function (t) {
            ...
            return i /= 100, r /= 108.883, n = (n /= 95.047) > 0.008856 ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116, [
            ...
            var e = t[0], n = t[1] / 100, i = t[2] / 100, a = n, r = Math.max(i, 0.01);
            ...
            var e, n, i, a = t[0], r = t[1] / 100, o = t[2] / 100, s = Math.max(o, 0.01);
            ...
            return n = -0.9689 * a + 1.8758 * r + 0.0415 * o, i = 0.0557 * a + -0.204 * r + 1.057 * o, e = (e = 3.2406 * a + -1.5372 * r + -0.4986 * o) > 0.0031308 ? 1.055 * Math.pow(e, 1 / 2.4) - 0.055 : 12.92 * e, n = n > 0.0031308 ? 1.055 * Math.pow(n, 1 / 2.4) - 0.055 : 12.92 * n, i = i > 0.0031308 ? 1.055 * Math.pow(i, 1 / 2.4) - 0.055 : 12.92 * i, [
            ...
            var e = t[0], n = t[1], i = t[2];
            return n /= 100, i /= 108.883, e = (e /= 95.047) > 0.008856 ? Math.pow(e, 1 / 3) : 7.787 * e + 16 / 116, [
            ...
            return n = r > 0.008856 ? r : (n - 16 / 116) / 7.787, e = o > 0.008856 ? o : (e - 16 / 116) / 7.787, i = s > 0.008856 ? s : (i - 16 / 116) / 7.787, [
              e *= 95.047,
              n *= 100,
              i *= 108.883
            ];
            ...
            return (i = n < 0.5 ? 2 * e * n : 2 * e * (1 - n)) < 1 && (a = (n - 0.5 * i) / (1 - i)), [
              t[0],
              100 * i,
              100 * a
            ];
            ...
            return n > 0 && n < 0.5 ? i = e / (2 * n) : n >= 0.5 && n < 1 && (i = e / (2 * (1 - n))), [
              t[0],
              100 * i,
              100 * n
            ];
      ...
      Object.keys(n).forEach(function (t) {
        ...
        var e = function (t) {
          for (var e = i(t), n = {}, a = Object.keys(e), r = a.length, s = 0; s < r; s++) {
            var l = a[s];
      ...
      var l = s, u = {
          ...
          getAlpha: function (t) {
            var e = h(t);
            return e || (e = c(t)) || (e = f(t)) ? e[3] : void 0;
          },
          hexString: function (t, e) {
            return e = void 0 !== e && 3 === t.length ? e : t[3], '#' + b(t[0]) + b(t[1]) + b(t[2]) + (e >= 0 && e < 1 ? b(Math.round(255 * e)) : '');
          },
      ...
      var _ = function t(e) {
        return e instanceof t ? e : this instanceof t ? (this.valid = !1, this.values = {
          ...
          alpha: 1
        }, void ('string' == typeof e ? (n = d.getRgba(e)) ? this.setValues('rgb', n) : (n = d.getHsla(e)) ? this.setValues('hsl', n) : (n = d.getHwb(e)) && this.setValues('hwb', n) : 'object' === r(e) && (void 0 !== (n = e).r || void 0 !== n.red ? this.setValues('rgb', n) : void 0 !== n.l || void 0 !== n.lightness ? this.setValues('hsl', n) : void 0 !== n.v || void 0 !== n.value ? this.setValues('hsv', n) : void 0 !== n.w || void 0 !== n.whiteness ? this.setValues('hwb', n) : void 0 === n.c && void 0 === n.cyan || this.setValues('cmyk', n)))) : new t(e);
        var n;
      };
      (_.prototype = {
        isValid: function () {
        ...
        mix: function (t, e) {
          var n = t, i = void 0 === e ? 0.5 : e, a = 2 * i - 1, r = this.alpha() - n.alpha(), o = ((a * r == -1 ? a : (a + r) / (1 + a * r)) + 1) / 2, s = 1 - o;
      ...
      var A = Math.PI, D = A / 180, T = 2 * A, I = A / 2, F = A / 4, O = 2 * A / 3, L = {
          ...
          drawPoint: function (t, e, n, i, a, o) {
            var s, l, u, d, h, c = (o || 0) * D;
            if (e && 'object' === r(e) && ('[object HTMLImageElement]' === (s = e.toString()) || '[object HTMLCanvasElement]' === s))
              return t.save(), t.translate(i, a), t.rotate(c), t.drawImage(e, -e.width / 2, -e.height / 2, e.width, e.height), void t.restore();
            if (!(isNaN(n) || n <= 0)) {
              ...
              case 'triangle':
                ...
                break;
              case 'rectRounded':
                d = n - (h = 0.516 * n), l = Math.cos(c + F) * d, u = Math.sin(c + F) * d, t.arc(i - l, a - u, h, c - A, c - I), t.arc(i + u, a - l, h, c - I, c), t.arc(i + l, a + u, h, c, c + I), t.arc(i - u, a + l, h, c + I, c + A), t.closePath();
                break;
              case 'rect':
                if (!o) {
                ...
                c += F;
              case 'rectRot':
                l = Math.cos(c) * n, u = Math.sin(c) * n, t.moveTo(i - l, a - u), t.lineTo(i + u, a - l), t.lineTo(i + l, a + u), t.lineTo(i - u, a + l), t.closePath();
                break;
              case 'crossRot':
                c += F;
              case 'cross':
                l = Math.cos(c) * n, u = Math.sin(c) * n, t.moveTo(i - l, a - u), t.lineTo(i + l, a + u), t.moveTo(i + u, a - l), t.lineTo(i - u, a + l);
                break;
              case 'star':
                l = Math.cos(c) * n, u = Math.sin(c) * n, t.moveTo(i - l, a - u), t.lineTo(i + l, a + u), t.moveTo(i + u, a - l), t.lineTo(i - u, a + l), c += F, l = Math.cos(c) * n, u = Math.sin(c) * n, t.moveTo(i - l, a - u), t.lineTo(i + l, a + u), t.moveTo(i + u, a - l), t.lineTo(i - u, a + l);
                break;
              case 'line':
                l = Math.cos(c) * n, u = Math.sin(c) * n, t.moveTo(i - l, a - u), t.lineTo(i + l, a + u);
                break;
              case 'dash':
          ...
          _isPointInArea: function (t, e) {
            return t.x > e.left - 0.000001 && t.x < e.right + 0.000001 && t.y > e.top - 0.000001 && t.y < e.bottom + 0.000001;
          },
      ...
      H.easing = j, H.canvas = q, H.options = U, H.math = Y, H.rtl = $;
      var G = function (t) {
      ...
      H.extend(G.prototype, {
        ...
        transition: function (t) {
          ...
          return n && 1 !== t ? (a || (a = e._view = {}), i || (i = e._start = {}), function (t, e, n, i) {
            var a, o, s, l, u, d, h, c, f, g = Object.keys(n);
            for (a = 0, o = g.length; a < o; ++a)
              if (d = n[s = g[a]], e.hasOwnProperty(s) || (e[s] = d), (l = e[s]) !== d && '_' !== s[0]) {
                if (t.hasOwnProperty(s) || (t[s] = l), u = t[s], (h = r(d)) === r(u))
                  if ('string' === h) {
                    if ((c = w(u)).valid && (f = w(d)).valid) {
                      e[s] = f.mix(c, i).rgbString();
                      continue;
                    }
      ...
      var J = {
          ...
          advance: function () {
            for (var t, e, n, i, a = this.animations, r = 0; r < a.length;)
              e = (t = a[r]).chart, n = t.numSteps, i = Math.floor((Date.now() - t.startTime) / t.duration * n) + 1, t.currentStep = Math.min(i, n), H.callback(t.render, [
                e,
                t
              ], e), H.callback(t.onAnimationProgress, [t], e), t.currentStep >= n ? (H.callback(t.onAnimationComplete, [t], e), e.animating = !1, a.splice(r, 1)) : ++r;
          }
      ...
      H.extend(nt.prototype, {
        ...
        _resolveDatasetElementOptions: function (t, e) {
          ...
          for (n = 0, i = h.length; n < i; ++n)
            a = h[n], r = e ? 'hover' + a.charAt(0).toUpperCase() + a.slice(1) : a, c[a] = Q([
              u[r],
              l[r],
              d[r]
            ], f);
      ...
      var st = X.extend({
          ...
          draw: function () {
            var t, e = this._chart.ctx, n = this._view, i = 'inner' === n.borderAlign ? 0.33 : 0, a = {
                x: n.x,
                y: n.y,
      ...
      var Ot = it.extend({
          ...
          updateElement: function (t, e, n) {
            var i = this, a = i.getMeta(), o = t.custom || {}, s = i.getScaleForId(a.xAxisID), l = i.getScaleForId(a.yAxisID), u = i._resolveDataElementOptions(t, e), d = i.getDataset().data[e], h = i.index, c = n ? s.getPixelForDecimal(0.5) : s.getPixelForValue('object' === r(d) ? d : NaN, e, h), f = n ? l.getBasePixel() : l.getPixelForValue(d, e, h);
            t._xScale = s, t._yScale = l, t._options = u, t._datasetIndex = h, t._index = e, t._model = {
      ...
      var Bt = it.extend({
        ...
        updateElement: function (t, e, n) {
          var i = this, a = i.chart, r = a.chartArea, o = a.options, s = o.animation, l = (r.left + r.right) / 2, u = (r.top + r.bottom) / 2, d = o.rotation, h = o.rotation, c = i.getDataset(), f = n && s.animateRotate || t.hidden ? 0 : i.calculateCircumference(c.data[e]) * (o.circumference / zt), g = n && s.animateScale ? 0 : i.innerRadius, p = n && s.animateScale ? 0 : i.outerRadius, m = t._options || {};
          H.extend(t, {
      ...
      var Yt = it.extend({
          ...
          updateElement: function (t, e, n) {
            var i, a, o = this, s = o.getMeta(), l = t.custom || {}, u = o.getDataset(), d = o.index, h = u.data[e], c = o._xScale, f = o._yScale, g = s.dataset._model, p = o._resolveDataElementOptions(t, e);
            i = c.getPixelForValue('object' === r(h) ? h : NaN, e, d), a = n ? f.getBasePixel() : o.calculatePointY(h, e, d), t._xScale = c, t._yScale = f, t._options = p, t._datasetIndex = d, t._index = e, t._model = {
              x: i,
              y: a,
              ...
              tension: Wt(l.tension, g ? g.tension : 0),
      ...
      function Se(t, e, n) {
        var i, a, r, o, s = t.$chartjs || (t.$chartjs = {}), l = s.resizer = function (t) {
            var e = Me('chartjs-size-monitor'), n = Me('chartjs-size-monitor-expand'), i = Me('chartjs-size-monitor-shrink');
            n.appendChild(Me()), i.appendChild(Me()), e.appendChild(n), e.appendChild(i), e._reset = function () {
              n.scrollLeft = 1000000, n.scrollTop = 1000000, i.scrollLeft = 1000000, i.scrollTop = 1000000;
            };
            var a = function () {
              e._reset(), t();
            };
            return _e(n, 'scroll', a.bind(n, 'expand')), _e(i, 'scroll', a.bind(i, 'shrink')), e;
          }((i = function () {
            if (s.resizer) {
              var i = n.options.maintainAspectRatio && t.parentNode, a = i ? i.clientWidth : 0;
              e(we('resize', n)), i && i.clientWidth < a && n.canvas && e(we('resize', n));
            }
          }, r = !1, o = [], function () {
        ...
        !function (t, e) {
          var n = t.$chartjs || (t.$chartjs = {}), i = n.renderProxy = function (t) {
      ...
      function Ce(t) {
        var e = t.$chartjs || {}, n = e.resizer;
        delete e.resizer, function (t) {
          var e = t.$chartjs || {}, n = e.renderProxy;
          n && (H.each(ve, function (e) {
            ke(t, e, n);
      ...
      var Pe = {
        ...
        addEventListener: function (t, e, n) {
          ...
          if ('resize' !== e) {
            ...
            _e(i, e, (a.proxies || (a.proxies = {}))[t.id + '_' + e] = function (e) {
              n(function (t, e) {
                var n = be[t.type] || t.type, i = H.getRelativePosition(t, e);
      ...
      var Te = {
          ...
          getScaleDefaults: function (t) {
            return this.defaults.hasOwnProperty(t) ? H.merge({}, [
              N.scale,
              this.defaults[t]
            ]) : {};
          },
        ...
        }, Fe = H.valueOrDefault, Oe = H.rtl.getRtlAdapter;
      N._set('global', {
        tooltips: {
          enabled: !0,
          custom: null,
      ...
      var We = X.extend({
          ...
          getTitle: function () {
            ...
            return o = Re(o, ze(i)), o = Re(o, ze(a)), o = Re(o, ze(r));
          },
          ...
          getBody: function (t, e) {
            ...
            return H.each(t, function (t) {
              ...
              Re(r.before, ze(i.beforeLabel.call(n, t, e))), Re(r.lines, i.label.call(n, t, e)), Re(r.after, ze(i.afterLabel.call(n, t, e))), a.push(r);
            }), a;
          },
          ...
          getFooter: function () {
            ...
            return r = Re(r, ze(n)), r = Re(r, ze(i)), r = Re(r, ze(a));
          },
          update: function (t) {
            var e, n, i, a, r, o, s, l, u, d, h = this, c = h._options, f = h._model, g = h._model = Ne(c), p = h._active, m = h._data, v = {
                xAlign: f.xAlign,
                yAlign: f.yAlign
              }, b = {
                x: f.x,
          ...
          drawTitle: function (t, e, n) {
            ...
            if (s) {
              ...
              for (t.x = Be(e, e._titleAlign), n.textAlign = l.textAlign(e._titleAlign), n.textBaseline = 'middle', i = e.titleFontSize, a = e.titleSpacing, n.fillStyle = e.titleFontColor, n.font = H.fontString(i, e._titleFontStyle, e._titleFontFamily), r = 0; r < s; ++r)
                n.fillText(o[r], l.x(t.x), t.y + i / 2), t.y += i + a, r + 1 === s && (t.y += e.titleMarginBottom - a);
            }
          },
          drawBody: function (t, e, n) {
            var i, a, r, o, s, l, u, d, h = e.bodyFontSize, c = e.bodySpacing, f = e._bodyAlign, g = e.body, p = e.displayColors, m = 0, v = p ? Be(e, 'left') : 0, b = Oe(e.rtl, e.x, e.width), x = function (e) {
                n.fillText(e, b.x(t.x + m), t.y + h / 2), t.y += h + c;
              }, y = b.textAlign(f);
            for (n.textAlign = f, n.textBaseline = 'middle', n.font = H.fontString(h, e._bodyFontStyle, e._bodyFontFamily), t.x = Be(e, y), n.fillStyle = e.bodyFontColor, H.each(e.beforeBody, x), m = p && 'right' !== y ? 'center' === f ? h / 2 + 1 : h + 2 : 0, s = 0, u = g.length; s < u; ++s) {
          ...
          drawFooter: function (t, e, n) {
            ...
            if (o) {
              ...
              for (t.x = Be(e, e._footerAlign), t.y += e.footerMarginTop, n.textAlign = s.textAlign(e._footerAlign), n.textBaseline = 'middle', i = e.footerFontSize, n.fillStyle = e.footerFontColor, n.font = H.fontString(i, e._footerFontStyle, e._footerFontFamily), a = 0; a < o; ++a)
          ...
          merger: function (t, e, n, i) {
            if ('xAxes' === t || 'yAxes' === t) {
              ...
              for (e[t] || (e[t] = []), a = 0; a < s; ++a)
                o = n[t][a], r = je(o.type, 'xAxes' === t ? 'category' : 'linear'), a >= e[t].length && e[t].push({}), !e[t][a].type || o.type && o.type !== e[t][a].type ? H.merge(e[t][a], [
                  Ie.getScaleDefaults(r),
                  o
                ]) : H.merge(e[t][a], o);
            } else
              H._merger(t, e, n, i);
      ...
      function Ue() {
        return H.merge({}, [].slice.call(arguments), {
          merger: function (t, e, n, i) {
            var a = e[t] || {}, r = n[t];
            'scales' === t ? e[t] = qe(a, r) : 'scale' === t ? e[t] = H.merge(a, [
              Ie.getScaleDefaults(r.type),
              r
            ]) : H._merger(t, e, n, i);
          }
        });
      ...
      function Ye(t) {
        ...
        H.each(t.scales, function (e) {
          pe.removeBox(t, e);
        }), e = Ue(N.global, N[t.config.type], e), t.options = t.config.options = e, t.ensureScalesHaveIDs(), t.buildOrUpdateScales(), t.tooltip._options = e.tooltips, t.tooltip.initialize();
      }
      function $e(t, e, n) {
        var i, a = function (t) {
            return t.id === i;
      ...
      H.extend(Ke.prototype, {
        construct: function (t, e) {
          ...
          var i = De.acquireContext(t, e), a = i && i.canvas, r = a && a.height, o = a && a.width;
          n.id = H.uid(), n.ctx = i, n.canvas = a, n.config = e, n.width = o, n.height = r, n.aspectRatio = r ? o / r : null, n.options = e.options, n._bufferedRender = !1, n._layers = [], n.chart = n, n.controller = n, Ke.instances[n.id] = n, Object.defineProperty(n, 'data', {
            get: function () {
        ...
        resize: function (t) {
          ...
          if ((e.width !== r || e.height !== o) && (i.width = e.width = r, i.height = e.height = o, i.style.width = r + 'px', i.style.height = o + 'px', H.retinaScale(e, n.devicePixelRatio), !t)) {
            ...
            Te.notify(e, 'resize', [s]), n.onResize && n.onResize(e, s), e.stop(), e.update({ duration: n.responsiveAnimationDuration });
          }
        },
        ...
        buildOrUpdateScales: function () {
          ...
          e.scales && (i = i.concat((e.scales.xAxes || []).map(function (t) {
            ...
            var i = e.options, r = i.id, o = je(i.type, e.dtype);
            Ge(i.position) !== Ge(e.dposition) && (i.position = e.dposition), a[r] = !0;
            var s = null;
            ...
            t || delete n[e];
          }), t.scales = n, Ie.addScalesToLayout(this);
        },
        ...
        update: function (t) {
          ...
          if (t && 'object' === r(t) || (t = {
              duration: t,
              lazy: arguments[1]
            }), Ye(i), Te._invalidate(i), !1 !== Te.notify(i, 'beforeUpdate')) {
            ...
            i.updateLayout(), i.options.animation && i.options.animation.duration && H.each(a, function (t) {
              t.reset();
            }), i.updateDatasets(), i.tooltip.initialize(), i.lastActive = [], Te.notify(i, 'afterUpdate'), i._layers.sort(Xe('z', '_idx')), i._bufferedRender ? i._bufferedRequest = {
              duration: t.duration,
              easing: t.easing,
              lazy: t.lazy
            } : i.render(t);
        ...
        updateLayout: function () {
          var t = this;
          !1 !== Te.notify(t, 'beforeLayout') && (pe.update(this, this.width, this.height), t._layers = [], H.each(t.boxes, function (e) {
        ...
        render: function (t) {
          ...
          var n = e.options.animation, i = je(t.duration, n && n.duration), a = t.lazy;
        ...
        destroy: function () {
          ...
          i && (n.unbindEvents(), H.canvas.clear(n), De.releaseContext(n.ctx), n.canvas = null, n.ctx = null), Te.notify(n, 'destroy'), delete Ke.instances[n.id];
        },
        ...
        bindEvents: function () {
          ...
          H.each(t.options.events, function (i) {
            ...
            t.resize();
          }, De.addEventListener(t, 'resize', n), e.resize = n);
        },
      ...
      Ke.Controller = Ke, Ke.types = {}, H.configMerge = Ue, H.scaleMerge = qe, H.extend(Qe.prototype, {
        formats: Je,
        parse: Je,
        format: Je,
        add: Je,
      ...
      var tn = { _date: Qe }, en = {
        ...
        }, nn = H.isArray, an = H.isNullOrUndef, rn = H.valueOrDefault, on = H.valueAtIndexOrDefault;
      function sn(t, e, n) {
        var i, a = t.getTicks().length, r = Math.min(e, a - 1), o = t.getPixelForTick(r), s = t._startPixel, l = t._endPixel;
        if (!(n && (i = 1 === a ? Math.max(o - s, l - o) : 0 === e ? (t.getPixelForTick(1) - o) / 2 : (o - t.getPixelForTick(r - 1)) / 2, (o += r < e ? i : -i) < s - 0.000001 || o > l + 0.000001)))
          return o;
      }
      function ln(t, e, n, i) {
        ...
        for (a = 0; a < v; ++a) {
          if (s = n[a].label, l = n[a].major ? e.major : e.minor, t.font = u = l.string, d = i[u] = i[u] || {
              data: {},
              gc: []
            }, h = l.lineHeight, c = f = 0, an(s) || nn(s)) {
            if (nn(s))
              for (r = 0, o = s.length; r < o; ++r)
                g = s[r], an(g) || nn(g) || (c = H.measureText(t, d.data, d.gc, c, g), f += h);
          } else
      ...
      function gn(t, e, n, i) {
        var a, r, o, s, l = rn(n, 0), u = Math.min(rn(i, t.length), t.length), d = 0;
      ...
      var pn = X.extend({
        ...
        afterBuildTicks: function (t) {
          var e = this;
          return nn(t) && t.length ? H.callback(e.options.afterBuildTicks, [
            e,
            t
        ...
        fit: function () {
          ...
          if (u ? e.width = t.maxWidth : s && (e.width = un(o) + dn(r)), u ? s && (e.height = un(o) + dn(r)) : e.height = t.maxHeight, a.display && s) {
            var d = cn(a), h = t._getLabelSizes(), c = h.first, f = h.last, g = h.widest, p = h.highest, m = 0.4 * d.minor.lineHeight, v = a.padding;
            if (u) {
        ...
        _parseValue: function (t) {
          var e, n, i, a;
          return nn(t) ? (e = +this.getRightValue(t[0]), n = +this.getRightValue(t[1]), i = Math.min(e, n), a = Math.max(e, n)) : (e = void 0, n = t = +this.getRightValue(t), i = t, a = t), {
            min: i,
            max: a,
            start: e,
            end: n
        ...
        _autoSkip: function (t) {
          ...
          if (i = function (t, e, n, i) {
            ...
            for (e = 0, n = u - 1; e < n; e++)
              gn(t, i, l[e], l[e + 1]);
            return a = u > 1 ? (h - d) / (u - 1) : null, gn(t, i, H.isNullOrUndef(a) ? 0 : d - a, d), gn(t, i, h, H.isNullOrUndef(a) ? t.length : h + a), fn(t);
          }
          return gn(t, i), fn(t);
        },
        _tickSize: function () {
        ...
        _computeGridLineItems: function (t) {
          var e, n, i, a, r, o, s, l, u, d, h, c, f, g, p, m, v, b = this, x = b.chart, y = b.options, _ = y.gridLines, k = y.position, w = _.offsetGridLines, M = b.isHorizontal(), S = b._ticksToDraw, C = S.length + (w ? 1 : 0), P = un(_), A = [], D = _.drawBorder ? on(_.lineWidth, 0, 0) : 0, T = D / 2, I = H._alignPixel, F = function (t) {
              return I(x, t, D);
            };
          for ('top' === k ? (e = F(b.bottom), s = b.bottom - P, u = e - T, h = F(t.top) + T, f = t.bottom) : 'bottom' === k ? (e = F(b.top), h = t.top, f = F(t.bottom) - T, s = e + T, u = b.top + P) : 'left' === k ? (e = F(b.right), o = b.right - P, l = e - T, d = F(t.left) + T, c = t.right) : (e = F(b.left), d = t.left, c = F(t.right) - T, o = e + T, l = b.left + P), n = 0; n < C; ++n)
            i = S[n] || {}, an(i.label) && n < S.length || (n === b.zeroLineIndex && y.offset === w ? (g = _.zeroLineWidth, p = _.zeroLineColor, m = _.zeroLineBorderDash || [], v = _.zeroLineBorderDashOffset || 0) : (g = on(_.lineWidth, n, 1), p = on(_.color, n, 'rgba(0,0,0,0.1)'), m = _.borderDash || [], v = _.borderDashOffset || 0), void 0 !== (a = sn(b, i._index || n, w)) && (r = I(x, a, g), M ? o = l = d = c = r : s = u = h = f = r, A.push({
              tx1: o,
              ty1: s,
              tx2: l,
              ty2: u,
        ...
        _computeLabelItems: function () {
          var t, e, n, i, a, r, o, s, l, u, d, h, c = this, f = c.options, g = f.ticks, p = f.position, m = g.mirror, v = c.isHorizontal(), b = c._ticksToDraw, x = cn(g), y = g.padding, _ = un(f.gridLines), k = -H.toRadians(c.labelRotation), w = [];
          for ('top' === p ? (r = c.bottom - _ - y, o = k ? 'left' : 'center') : 'bottom' === p ? (r = c.top + _ + y, o = k ? 'right' : 'center') : 'left' === p ? (a = c.right - (m ? 0 : _) - y, o = m ? 'left' : 'right') : (a = c.left + (m ? 0 : _) + y, o = m ? 'right' : 'left'), t = 0, e = b.length; t < e; ++t)
            i = (n = b[t]).label, an(i) || (s = c.getPixelForTick(n._index || t) + g.labelOffset, u = (l = n.major ? x.major : x.minor).lineHeight, d = nn(i) ? i.length : 1, v ? (a = s, h = 'top' === p ? ((k ? 1 : 0.5) - d) * u : (k ? 0 : 0.5) * u) : (r = s, h = (1 - d) * u / 2), w.push({
              x: a,
              y: r,
              rotation: k,
              label: i,
        ...
        _drawGrid: function (t) {
          ...
          if (n.display) {
            var i, a, r, o, s, l = e.ctx, u = e.chart, d = H._alignPixel, h = n.drawBorder ? on(n.lineWidth, 0, 0) : 0, c = e._gridLineItems || (e._gridLineItems = e._computeGridLineItems(t));
            ...
            if (h) {
              var f, g, p, m, v = h, b = on(n.lineWidth, c.ticksLength - 1, 1), x = c.borderValue;
              e.isHorizontal() ? (f = d(u, e.left, v) - v / 2, g = d(u, e.right, b) + b / 2, p = m = x) : (p = d(u, e.top, v) - v / 2, m = d(u, e.bottom, b) + b / 2, f = g = x), l.lineWidth = h, l.strokeStyle = on(n.color, 0), l.beginPath(), l.moveTo(f, p), l.lineTo(g, m), l.stroke();
            }
          }
        },
        _drawLabels: function () {
          ...
          if (t.options.ticks.display) {
            ...
            for (e = 0, i = d.length; e < i; ++e) {
              if (o = (r = d[e]).font, u.save(), u.translate(r.x, r.y), u.rotate(r.rotation), u.font = o.string, u.fillStyle = o.color, u.textBaseline = 'middle', u.textAlign = r.textAlign, s = r.label, l = r.textOffset, nn(s))
        ...
        _drawTitle: function () {
          ...
          if (i.display) {
            var a, r, o = rn(i.fontColor, N.global.defaultFontColor), s = H.options._parseFont(i), l = H.options.toPadding(i.padding), u = s.lineHeight / 2, d = n.position, h = 0;
            if (t.isHorizontal())
      ...
      var mn = pn, vn = H.isNullOrUndef, bn = mn.extend({
          ...
          _configure: function () {
            ...
            mn.prototype._configure.call(t), t.isHorizontal() || (t._reversePixels = !t._reversePixels), n && (t._startValue = t.minIndex - (e ? 0.5 : 0), t._valueRange = Math.max(n.length - (e ? 0 : 1), 1));
          },
          getPixelForValue: function (t, e, n) {
            var i, a, r, o = this;
            return vn(e) || vn(n) || (t = o.chart.data.datasets[n].data[e]), vn(t) || (i = o.isHorizontal() ? t.x : t.y), (void 0 !== i || void 0 !== t && isNaN(e)) && (a = o._getLabels(), t = H.valueOrDefault(i, t), e = -1 !== (r = a.indexOf(t)) ? r : e, isNaN(e) && (e = t)), o.getPixelForDecimal((e - o._startValue) / o._valueRange);
          },
          getPixelForTick: function (t) {
            var e = this.ticks;
      ...
      bn._defaults = xn;
      var yn = H.noop, _n = H.isNullOrUndef, kn = mn.extend({
          getRightValue: function (t) {
          ...
          buildTicks: function () {
            var t = this, e = t.options.ticks, n = t.getTickLimit(), i = {
                ...
                if (p < 1e-14 && _n(d) && _n(h))
                  return [
                    f,
                    g
                  ];
                (r = Math.ceil(g / p) - Math.floor(f / p)) > u && (p = H.niceNum(r * p / u / l) * l), s || _n(c) ? n = Math.pow(10, H._decimalPlaces(p)) : (n = Math.pow(10, c), p = Math.ceil(p * n) / n), i = Math.floor(f / p) * p, a = Math.ceil(g / p) * p, s && (!_n(d) && H.almostWhole(d / p, p / 1000) && (i = d), !_n(h) && H.almostWhole(h / p, p / 1000) && (a = h)), r = (a - i) / p, r = H.almostEquals(r, Math.round(r), p / 1000) ? Math.round(r) : Math.ceil(r), i = Math.round(i * n) / n, a = Math.round(a * n) / n, o.push(_n(d) ? i : d);
                for (var m = 1; m < r; ++m)
          ...
          _configure: function () {
            ...
            mn.prototype._configure.call(e), e.options.offset && n.length && (i -= t = (a - i) / Math.max(n.length - 1, 1) / 2, a += t), e._startValue = i, e._endValue = a, e._valueRange = a - i;
          }
        }), wn = {
          position: 'left',
          ticks: { callback: en.formatters.linear }
        };
      function Mn(t, e, n, i) {
      ...
      var Cn = kn.extend({
          determineDataLimits: function () {
            ...
            for (t = 0; t < d; ++t)
              n = o[(e = s[t]).index].data, l ? Mn(a, u, e, n) : Sn(a, e, n);
            H.each(u, function (t) {
      ...
      Cn._defaults = Pn;
      var An = H.valueOrDefault, Dn = H.math.log10, Tn = {
          position: 'left',
      ...
      var Fn = mn.extend({
          ...
          buildTicks: function () {
            var t = this, e = t.options.ticks, n = !t.isHorizontal(), i = {
                ...
                var n, i, a = [], r = An(t.min, Math.pow(10, Math.floor(Dn(e.min)))), o = Math.floor(Dn(e.max)), s = Math.ceil(e.max / Math.pow(10, o));
                0 === r ? (n = Math.floor(Dn(e.minNotZero)), i = Math.floor(e.minNotZero / Math.pow(10, n)), a.push(r), r = i * Math.pow(10, n)) : (n = Math.floor(Dn(r)), i = Math.floor(r / Math.pow(10, n)));
          ...
          _configure: function () {
            ...
            mn.prototype._configure.call(t), 0 === e && (e = t._getFirstTickValue(t.minNotZero), n = An(t.options.ticks.fontSize, N.global.defaultFontSize) / t._length), t._startValue = Dn(e), t._valueOffset = n, t._valueRange = (Dn(t.max) - Dn(e)) / (1 - n);
          },
          getPixelForValue: function (t) {
            var e = this, n = 0;
            return (t = +e.getRightValue(t)) > e.min && t > 0 && (n = (Dn(t) - e._startValue) / e._valueRange + e._valueOffset), e.getPixelForDecimal(n);
          },
          getValueForPixel: function (t) {
      ...
      Fn._defaults = On;
      var Ln = H.valueOrDefault, Rn = H.valueAtIndexOrDefault, zn = H.options.resolve, Nn = {
          display: !0,
          animate: !0,
          position: 'chartArea',
          angleLines: {
      ...
      function Bn(t) {
        var e = t.ticks;
        return e.display && t.display ? Ln(e.fontSize, N.global.defaultFontSize) + 2 * e.backdropPaddingY : 0;
      }
      ...
      var qn = kn.extend({
          ...
          fit: function () {
            ...
            t.display && t.pointLabels.display ? function (t) {
              ...
              for (e = 0; e < d; e++) {
                ...
                var h = t.getIndexAngle(e), c = H.toDegrees(h) % 360, f = En(c, i.x, n.w, 0, 180), g = En(c, i.y, n.h, 90, 270);
          ...
          setReductions: function (t, e, n) {
            ...
            a = jn(a), r = jn(r), o = jn(o), s = jn(s), i.drawingArea = Math.min(Math.floor(t - (a + r) / 2), Math.floor(t - (o + s) / 2)), i.setCenterPoint(a, r, o, s);
          },
          ...
          _drawGrid: function () {
            var t, e, n, i = this, a = i.ctx, r = i.options, o = r.gridLines, s = r.angleLines, l = Ln(s.lineWidth, o.lineWidth), u = Ln(s.color, o.color);
            if (r.pointLabels.display && function (t) {
                var e = t.ctx, n = t.options, i = n.pointLabels, a = Bn(n), r = t.getDistanceFromCenterForValue(n.ticks.reverse ? t.min : t.max), o = H.options._parseFont(i);
                e.save(), e.font = o.string, e.textBaseline = 'middle';
                for (var s = t.chart.data.labels.length - 1; s >= 0; s--) {
                  var l = 0 === s ? a / 2 : 0, u = t.getPointPosition(s, r + l + 5), d = Rn(i.fontColor, s, N.global.defaultFontColor);
                  e.fillStyle = d;
                  var h = t.getIndexAngle(s), c = H.toDegrees(h);
                  e.textAlign = Wn(c), Hn(c, t._pointLabelSizes[s], u), Vn(e, t.pointLabels[s], u, o.lineHeight);
                }
                e.restore();
              }(i), o.display && H.each(i.ticks, function (t, n) {
                0 !== n && (e = i.getDistanceFromCenterForValue(i.ticksAsNumbers[n]), function (t, e, n, i) {
                  var a, r = t.ctx, o = e.circular, s = t.chart.data.labels.length, l = Rn(e.color, i - 1), u = Rn(e.lineWidth, i - 1);
                  if ((o || s) && l && u) {
              ...
              for (a.save(), a.lineWidth = l, a.strokeStyle = u, a.setLineDash && (a.setLineDash(zn([
                  s.borderDash,
                  o.borderDash,
                  []
                ])), a.lineDashOffset = zn([
          ...
          _drawLabels: function () {
            ...
            if (n.display) {
              var i, a, r = t.getIndexAngle(0), o = H.options._parseFont(n), s = Ln(n.fontColor, N.global.defaultFontColor);
      ...
      qn._defaults = Un;
      var Yn = H._deprecated, $n = H.options.resolve, Gn = H.valueOrDefault, Xn = Number.MIN_SAFE_INTEGER || -9007199254740991, Kn = Number.MAX_SAFE_INTEGER || 9007199254740991, Zn = {
          millisecond: {
            common: !0,
            size: 1,
            steps: 1000
      ...
      function ai(t, e) {
        if (H.isNullOrUndef(e))
          return null;
        var n = t.options.time, i = ii(t, t.getRightValue(e));
        return null === i || n.round && (i = +t._adapter.startOf(i, n.round)), i;
      }
      function ri(t, e, n, i) {
        var a, r, o, s = Jn.length;
        for (a = Jn.indexOf(t); a < s - 1; ++a)
          if (o = (r = Zn[Jn[a]]).steps ? r.steps : Kn, r.common && Math.ceil((n - e) / (o * r.size)) <= i)
            return Jn[a];
        return Jn[s - 1];
      }
      function oi(t, e, n) {
      ...
      var si = mn.extend({
          ...
          update: function () {
            var t = this, e = t.options, n = e.time || (e.time = {}), i = t._adapter = new tn._date(e.adapters.date);
            return Yn('time scale', n.format, 'time.format', 'time.parser'), Yn('time scale', n.min, 'time.min', 'ticks.min'), Yn('time scale', n.max, 'time.max', 'ticks.max'), H.mergeIf(n.displayFormats, i.formats()), mn.prototype.update.apply(t, arguments);
          },
          getRightValue: function (t) {
            return t && void 0 !== t.t && (t = t.t), mn.prototype.getRightValue.call(this, t);
          },
          determineDataLimits: function () {
            var t, e, n, i, a, r, o, s = this, l = s.chart, u = s._adapter, d = s.options, h = d.time.unit || 'day', c = Kn, f = Xn, g = [], p = [], m = [], v = s._getLabels();
            ...
            m.length && (c = Math.min(c, m[0]), f = Math.max(f, m[m.length - 1])), g.length && (g = n > 1 ? function (t) {
              ...
              return r;
            }(g).sort(Qn) : g.sort(Qn), c = Math.min(c, g[0]), f = Math.max(f, g[g.length - 1])), c = ai(s, ti(d)) || c, f = ai(s, ei(d)) || f, c = c === Kn ? +u.startOf(Date.now(), h) : c, f = f === Xn ? +u.endOf(Date.now(), h) + 1 : f, s.min = Math.min(c, f), s.max = Math.max(c + 1, f), s._table = [], s._timestamps = {
              data: g,
              datasets: p,
              labels: m
            };
          ...
          buildTicks: function () {
            ...
            for (u = 'data' === c || 'auto' === c && 'series' === f ? u.data : 'labels' === c ? u.labels : function (t, e, n, i) {
                var a, r = t._adapter, o = t.options, s = o.time, l = s.unit || ri(s.minUnit, e, n, i), u = $n([
                    s.stepSize,
                    s.unitStepSize,
                    1
                  ]), d = 'week' === l && s.isoWeekday, h = e, c = [];
                if (d && (h = +r.startOf(h, 'isoWeek', d)), h = +r.startOf(h, d ? 'day' : l), r.diff(n, e, l) > 100000 * u)
                  throw e + ' and ' + n + ' are too far apart with stepSize of ' + u + ' ' + l;
                for (a = h; a < n; a = +r.add(a, u, l))
                  c.push(a);
                return a !== n && 'ticks' !== o.bounds || c.push(a), c;
              }(i, a, r, h), 'ticks' === o.bounds && u.length && (a = u[0], r = u[u.length - 1]), a = ai(i, ti(o)) || a, r = ai(i, ei(o)) || r, t = 0, e = u.length; t < e; ++t)
              (n = u[t]) >= a && n <= r && d.push(n);
            return i.min = a, i.max = r, i._unit = l.unit || (s.autoSkip ? ri(l.minUnit, i.min, i.max, h) : function (t, e, n, i, a) {
              var r, o;
              for (r = Jn.length - 1; r >= Jn.indexOf(n); r--)
                if (o = Jn[r], Zn[o].common && t._adapter.diff(a, i, o) >= e - 1)
                  return o;
              ...
              var r, o, s = 0, l = 0;
              return a.offset && e.length && (r = ni(t, 'time', e[0], 'pos'), s = 1 === e.length ? 1 - r : (ni(t, 'time', e[1], 'pos') - r) / 2, o = ni(t, 'time', e[e.length - 1], 'pos'), l = 1 === e.length ? o : (o - ni(t, 'time', e[e.length - 2], 'pos')) / 2), {
                start: s,
                end: l,
                factor: 1 / (s + 1 + l)
              };
          ...
          getLabelForIndex: function (t, e) {
            ...
            return H.isObject(s) && (o = n.getRightValue(s)), r.tooltipFormat ? i.format(ii(n, o), r.tooltipFormat) : 'string' == typeof o ? o : i.format(ii(n, o), r.displayFormats.datetime);
          },
          ...
          getPixelForOffset: function (t) {
            var e = this._offsets, n = ni(this._table, 'time', t, 'pos');
            return this.getPixelForDecimal((e.start + n) * e.factor);
          },
          getPixelForValue: function (t, e, n) {
            var i = null;
            if (void 0 !== e && void 0 !== n && (i = this._timestamps.datasets[n][e]), null === i && (i = ai(this, t)), null !== i)
          ...
          getValueForPixel: function (t) {
            var e = this._offsets, n = this.getDecimalForPixel(t) / e.factor - e.end, i = ni(this._table, 'pos', n, 'time');
            return this._adapter._create(i);
          },
          _getLabelSize: function (t) {
            var e = this.options.ticks, n = this.ctx.measureText(t).width, i = H.toRadians(this.isHorizontal() ? e.maxRotation : e.minRotation), a = Math.cos(i), r = Math.sin(i), o = Gn(e.fontSize, N.global.defaultFontSize);
            return {
              w: n * a + o * r,
              h: n * r + o * a
            };
          ...
          getLabelCapacity: function (t) {
            var e = this, n = e.options.time, i = n.displayFormats, a = i[n.unit] || i.millisecond, r = e.tickFormatFunction(t, 0, oi(e, [t], e._majorUnit), a), o = e._getLabelSize(r), s = Math.floor(e.isHorizontal() ? e.width / o.w : e.height / o.h);
      ...
      function bi(t, e, n, i, a, r) {
        ...
        for (t.beginPath(), o = 0, s = g; o < s; ++o)
          d = n(u = e[l = o % g]._view, l, i), h = mi(u), c = mi(d), r && void 0 === f && h && (s = g + (f = o + 1)), h && c ? (b = m.push(u), x = v.push(d)) : b && x && (p ? (h && m.push(u), c && v.push(d)) : (vi(t, m, v, b, x), b = x = 0, m = [], v = []));
      ...
      var xi = {
          ...
          afterDatasetsUpdate: function (t, e) {
            ...
            for (i = 0; i < o; ++i)
              (r = l[i]) && (r.fill = gi(l, i, s), r.boundary = fi(r), r.mapper = pi(r));
          },
          beforeDatasetsDraw: function (t) {
            var e, n, i, a, r, o, s, l = t._getSortedVisibleDatasetMetas(), u = t.ctx;
            for (n = l.length - 1; n >= 0; --n)
              (e = l[n].$filler) && e.visible && (a = (i = e.el)._view, r = i._children || [], o = e.mapper, s = a.backgroundColor || N.global.defaultColor, o && s && r.length && (H.canvas.clipArea(u, t.chartArea), bi(u, r, o, a, s, i._loop), H.canvas.unclipArea(u)));
          }
        }, yi = H.rtl.getRtlAdapter, _i = H.noop, ki = H.valueOrDefault;
      function wi(t, e) {
      ...
      var Mi = X.extend({
        ...
        draw: function () {
          ...
          if (e.display) {
            var d, h = yi(e.rtl, t.left, t.minSize.width), c = t.ctx, f = ki(n.fontColor, i.defaultFontColor), g = H.options._parseFont(n), p = g.size;
            c.textAlign = h.textAlign('left'), c.textBaseline = 'middle', c.lineWidth = 0.5, c.strokeStyle = f, c.fillStyle = f, c.font = g.string;
            var m = wi(n, p), v = t.legendHitBoxes, b = function (t, i) {
                switch (e.align) {
                case 'start':
                  return n.padding;
                case 'end':
            ...
            H.each(t.legendItems, function (e, i) {
              ...
              !function (t, e, i) {
                if (!(isNaN(m) || m <= 0)) {
                  ...
                  if (c.fillStyle = ki(i.fillStyle, a), c.lineCap = ki(i.lineCap, r.borderCapStyle), c.lineDashOffset = ki(i.lineDashOffset, r.borderDashOffset), c.lineJoin = ki(i.lineJoin, r.borderJoinStyle), c.lineWidth = o, c.strokeStyle = ki(i.strokeStyle, a), c.setLineDash && c.setLineDash(ki(i.lineDash, r.borderDash)), n && n.usePointStyle) {
      ...
      var Ci = {
          ...
          beforeUpdate: function (t) {
            ...
            e ? (H.mergeIf(e, N.global.legend), n ? (pe.configure(t, n, e), n.options = e) : Si(t, e)) : n && (pe.removeBox(t, n), delete t.legend);
          },
      ...
      var Ai = X.extend({
        ...
        draw: function () {
          ...
          if (n.display) {
            ...
            e.fillStyle = H.valueOrDefault(n.fontColor, N.global.defaultFontColor), e.font = o.string, t.isHorizontal() ? (a = h + (f - h) / 2, r = d + l, i = f - h) : (a = 'left' === n.position ? h + l : f - l, r = d + (c - d) / 2, i = c - d, u = Math.PI * ('left' === n.position ? -0.5 : 0.5)), e.save(), e.translate(a, r), e.rotate(u), e.textAlign = 'center', e.textBaseline = 'middle';
            var g = n.text;
            if (H.isArray(g))
      ...
      var Ti = {}, Ii = xi, Fi = Ci, Oi = {
          ...
          beforeUpdate: function (t) {
            ...
            e ? (H.mergeIf(e, N.global.title), n ? (pe.configure(t, n, e), n.options = e) : Di(t, e)) : n && (pe.removeBox(t, n), delete t.titleBlock);
          }
        };
      for (var Li in (Ti.filler = Ii, Ti.legend = Fi, Ti.title = Oi, Ze.helpers = H, function () {
          function t(t, e, n) {
            var i;
        ...
        }(), Ze._adapters = tn, Ze.Animation = Z, Ze.animationService = J, Ze.controllers = Jt, Ze.DatasetController = it, Ze.defaults = N, Ze.Element = X, Ze.elements = kt, Ze.Interaction = re, Ze.layouts = pe, Ze.platform = De, Ze.plugins = Te, Ze.Scale = mn, Ze.scaleService = Ie, Ze.Ticks = en, Ze.Tooltip = He, Ze.helpers.each(ui, function (t, e) {
          Ze.scaleService.registerScaleType(e, t, t._defaults);
        }), Ti))
        Ti.hasOwnProperty(Li) && Ze.plugins.register(Ti[Li]);
      Ze.platform.initialize();
      var Ri = Ze;
      return 'undefined' != typeof window && (window.Chart = Ze), Ze.Chart = Ze, Ze.Legend = Ti.legend._element, Ze.Title = Ti.title._element, Ze.pluginService = Ze.plugins, Ze.PluginBase = Ze.Element.extend({}), Ze.canvasHelpers = Ze.helpers.canvas, Ze.layoutService = Ze.layouts, Ze.LinearScaleBase = kn, Ze.helpers.each([
        'Bar',
        'Bubble',
        'Doughnut',
        'Line',
        ...
        Ze[t] = function (e, n) {
          return new Ze(e, Ze.helpers.merge(n || {}, { type: t.charAt(0).toLowerCase() + t.slice(1) }));
        };
      }), Ri;
    }, 'object' === r(e) && void 0 !== t ? t.exports = a(function () {
      try {
        return n('wd/R');
      } catch (t) {
      }
