    ...
    var H = function (e, t) {
        ...
        return t = i, (a = [
          ...
          },
          {
            key: 'onHost',
            value: function () {
              this.loading || getPref('essentialPatches') ? (this.loading = !0, window.navTo('/host?id='.concat(this.state.game.id))) : (this.loading = !0, window.open('/host?id='.concat(this.state.game.id), '_blank').focus(), window.location.reload());
            }
          },
          {
            key: 'onSolo',
            value: function () {
              this.loading || getPref('essentialPatches') ? (this.loading = !0, window.navTo('/solo?id='.concat(this.state.game.id))) : (this.loading = !0, this.state.game.id && window ? (window.open('/solo?id='.concat(this.state.game.id), '_blank').focus(), window.location.reload()) : this.loading = !1);
            }
          },
          {
            key: 'onReport',
          ...
          },
          {
            ...
            value: function () {
              ...
              }, this.state.game.author), (getPref('spoofAdmin') ? true : [
                'Bot',
                'Tom@Blooket'
            ...
            return regeneratorRuntime.wrap(function (e) {
              for (;;)
                ...
                case 2:
                  ...
                  return e.abrupt('return', this.props.history.push('/login'));
                case 5:
                  this.name = t.name, (getPref('spoofAdmin') ? true : [
                    'Bot',
                    'Ben',
                    'test'
